...
public class BinaryAssignment {
    ...
    public static int _findDistance(Node root, int n1, int n2) {
        ...
        System.out.println(left + " " + right + " " + root.value);
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Dist(3, 8) = "
                + findDistance(root, 3, 8));

        System.out.println("Dist(2, 4) = "
                + findDistance(root, 2, 4));

        System.out.println("Dist(8, 9) = "
                + findDistance(root, 8, 9));
    }
}
